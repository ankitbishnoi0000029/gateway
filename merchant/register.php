...
<head>
    ...
    <!-- Favicons -->
    <link href="https://pay.a1ejankari.com/newassets/images/favicon.png" rel="icon">
    <link href="https://pay.a1ejankari.com/newassets/images/favicon.png" rel="apple-touch-icon">
...
<body>
    <!-- Audio Element -->
    <audio id="loginSound" src="https://pay.a1ejankari.com/Voice/Register.mp3" preload="auto"></audio>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-dark" onclick="window.location.href='https://pay.a1ejankari.com'">Leave</button>
