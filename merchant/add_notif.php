...
//   error_reporting(E_ALL);
  ...
  if (isset($_POST['create'])) {
      ...
      $addnotif = $conn->query("INSERT INTO `notification`(`title`, `message`, `user_id`) VALUES ('$title','$message','All')");
        ...
        $("#loading_ajax").hide();
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = "add_notif";
                            }
                        });
                    </script>';
                    exit;
  ...
  if (isset($_POST['delete'])) {
      ...
      $id = $_POST["srno"];
      $deletenotif = $conn->query("DELETE FROM `notification` WHERE id = '$id'");
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-user-plus"></i> Notification</h1>
...
<?php if($userdata["role"] == 'Admin'){  ?>
 ...
 <form class="row mb-4" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    ...
    <div class="col-md-12 mb-2 mt-2"><button type="submit" name="create" class="btn btn-primary btn-sm">Submit</button>
         ...
         <h4 class="page-title">List Of Notification</h4>
						<div class="row row-card-no-pd">
							<div class="col-md-12">
