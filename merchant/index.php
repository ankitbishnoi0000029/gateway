...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link href="https://dragonspay.com/newassets/images/favicon.png" rel="icon">
    <link href="https://dragonspay.com/newassets/images/favicon.png" rel="apple-touch-icon">
    
    <title>Dragons Pay - Instant UPI Payments Solution</title>
     ...
     <div class="login-container">
                ...
                <div id="loginformbox">
                  <form class="login-form" method="POST" id="login_form">
                    ...
                    <!-- Google reCAPTCHA -->
                    <div class="g-recaptcha mb-3" data-sitekey="6Lc9tU0sAAAAAK9ANiYF6LT4SWM-G3v7i1rdOkp7"></div>
