...
$date=todaysDate();
 ...
 $txn_data = file_get_contents('https://pay.a1ejankari.com/HDFCSoft/miniStatement.php?&count=10&no='.$no.'&tidList='.$dynamicNumber.'&sessionid='.$sessionId.'&startDate='.$date.'&endDate='.$date.''); 
