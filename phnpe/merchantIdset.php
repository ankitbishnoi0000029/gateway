...
##################################################33
 ...
 $data0='';
$checksum = file_get_contents("https://pay.a1ejankari.com/phnpe/checksum_my.php?trd=$bbk1");
...
##################################################33
 ...
 $lenth=strlen($data0);
$checksum = file_get_contents("https://pay.a1ejankari.com/phnpe/checksum_my.php?trd=$bbk1$data0");
  $checksum= substr("$checksum",4);
