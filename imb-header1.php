...
<head>
    ...
    <title>Payment Gateway Services - imb Pay UPI Solutions</title>
    <meta name="description" content="Explore imb Pay's complete UPI payment services including instant payments, merchant solutions, secure transactions, and easy integration">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="shortcut icon" type="image/x-icon" href="newassets/images/favicon.png">
