...
<head>
    <meta charset="utf-8">
    <title>imb Pay</title>
    <meta name="Description" content="Pay via Imb Payment | UPI Payments Gateway">
    ...
    <link rel="icon" href="https://pay.a1ejankari.com/payment/bhim_icon.png" />
...
.success-screen {
    ...
    <link href="https://pay.a1ejankari.com/payment3/assets/css/checkout.css" rel="preload" as="style">
    <link rel="stylesheet" type="text/css" href="https://pay.a1ejankari.com/payment3/assets/css/checkout.css">
    ...
    <link rel="stylesheet" type="text/css" href="https://pay.a1ejankari.com/payment3/assets/css/route-onboard.chunk.css">
    ...
    <link rel="stylesheet" type="text/css" href="https://pay.a1ejankari.com/payment3/assets/css/checkout.chunk.css">
...
if($redirect_url==''){
$redirect_url='https://pay.a1ejankari.com/';    
}
...
$slq_p = "SELECT * FROM amazon_pay where user_token='$usermodetoken' AND id='$mid'";
        $res_p = getXbyY($slq_p);    
 ...
 $transactionId=$cxrbytectxnref;
$orders="upi://pay?pa=$upi_id&am=$amount&pn=$unitId&tn=$asdasd23&tid=$transactionId";
        ...
        <div class="vAlign-wrapper">
            <div class="vAlign-inner-wrap">
                <div class="vAling-content">
                    <div id="pageLoader"><img alt="" class="logo-icon dsk-icon" src="https://pay.a1ejankari.com/payment3/assets/favicon.png">
                        <h2>Please wait...</h2>
                                                    ...
                                                    <div class="loader__HVNkL">
                                                        <div class="countdown__RBXqR">
                                                            ...
                                                            <div class="loaderContainer__qoK5u">
                                                                <img src="https://pay.a1ejankari.com/payment3/assets/images/backgrounds/spinner-1.gif" alt="Loading...">
                                                            </div>
                                                        </div>
                                                    </div>
...
<div class="payment-option">
    <div style="display: flex;align-items: center;">
        <img src="https://<?= $_SERVER["SERVER_NAME"] ?>/payment6/Img/paytm.png" alt="Paytm UPI">
                                ...
                                <?php if($res_pmode[0]['pg_pby'] == '1'){ ?>
                                    <div class="phonepeBrandInfo__PONIY">
                                        <span class="phonepeLabel__xk3Bl">
									        Powered by
											<img src="https://pay.a1ejankari.com/newassets/images/Logo.png" style="width: 113px;margin-left: -9px;margin-top: -9px;">
										</span>
                                    </div>
                                 <?php } ?>
                                </div>
...
<div class="failure-screen" id="failureScreen">
    ...
    <script>
                ...
                if (m < 0) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "https://pay.img.org.in";
                        }
                    });
                    return;
                }
        ...
        upiCountdown("timeout", 3, 0, location.href);
    ...
    $.ajax({
        type: 'post',
        url: 'https://pay.a1ejankari.com/order9/payment-status',
        data: {'orderid' : '<?php echo $order_id?>','txnid' : '<?= $transactionId ?>'},
