...
// Sanitizing all input parameters
$no = sanitizeInput($_REQUEST['no']);
$password = sanitizeInput($_REQUEST['password']);
$tidList = sanitizeInput($_REQUEST['tidList']);
$sessionid = sanitizeInput($_REQUEST['sessionid']);
$upi = sanitizeInput($_REQUEST['upi']);
$cnumber = sanitizeInput($_REQUEST['cnumber']);
$amount = sanitizeInput($_REQUEST['amount']);
$dis = sanitizeInput($_REQUEST['dis']);
