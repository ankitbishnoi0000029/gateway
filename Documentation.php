                        ...
                        <div class="docs-content">
                            ...
                            <div class="docs-section">
                                ...
                                <div class="alert alert-info">
                                    <h4>Base URL</h4>
                                    <p>All API endpoints start with: <code>https://pay.a1ejankari.com/api/</code></p>
                                </div>
...

{
    ...
    "message": "Invalid user_token"
                            ...
                            <div class="docs-section">
                                ...
                                <ul>
                                    <li>Email: <a href="mailto:support@pay.a1ejankari.com">support@pay.a1ejankari.com</a></li>
