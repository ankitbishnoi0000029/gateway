...
if (isset($_SESSION['username'])) {
    ...
    $userdata = mysqli_fetch_array($uu);
     ...
     if($userdata["pg_mode"] == 2){
        echo '<script> window.location.href = "../imb Paypro/dashboard"; </script>';
        exit;
     } 
     if($userdata["pg_mode"] == 3){
        echo '<script> window.location.href = "../imb Paypg/dashboard"; </script>';
        exit;
     } 
...
<html lang="en">
  <head>
    <meta name="description" content="Green Pay Payment Gateway provides secure and efficient UPI payment gateway services and QR code payment solutions. Simplify your transactions with our reliable and user-friendly platform.">
    <meta name="keyword" content="Green Pay Payment Gateway, UPI payment gateway, QR code payment solutions, secure online payments, digital payment solutions, UPI services, QR code transactions, online payment gateway, payment processing, merchant services">
   
    <!-- Open Graph Meta-->
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Green Pay Payment Gateway">
    <meta property="og:title" content="Green Pay Payment Gateway - Secure UPI and QR Code Payment Solutions">
    <meta property="og:url" content="#">
    <meta property="og:image" content="#">
    <meta property="og:description" content="Green Pay Payment Gateway provides secure and efficient UPI payment gateway services and QR code payment solutions. Simplify your transactions with our reliable and user-friendly platform.">
    <title>Green Pay  | UPI PG</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.css" />
      <link rel="icon" type="image/png" href="https://pay.a1ejankari.com/newassets/images/favicon.png">
...
<div class="modal fade" id="confirmswitchmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-confirm modal-lg" style="width: 40vw;">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <ul class="my-2 changemodelist">
                ...
                <li>Collect Payments in Green Pay Wallet.</li>
    ...
    background: #0c254c;
"><img src="https://pay.a1ejankari.com/newassets/images/Logo.png" alt="Logo"></a>
