            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow p-4 border-0 h-100">
                    <div class="card-body">
                        ...
                        <p class="mb-2"><strong>Email:</strong> <br><a href="mailto:info@pay.a1ejankari.com">info@pay.a1ejankari.com</a></p>
                        <h5 class="mt-3">Email Support</h5>
                        <p>Send us your query on email.</p>
                        <a href="mailto:info@pay.a1ejankari.com" class="btn btn-primary btn-sm">Send Email</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow p-4 border-0 h-100">
                    <div class="card-body">
                        ...
                        <p class="mb-2"><strong>Phone:</strong> <br><a href="tel:+916200218694">+91 6200218694</a></p>
                        <h5 class="mt-3">Call Support</h5>
                        <p>Talk directly to our support team.</p>
                        <a href="tel:+916200218694" class="btn btn-info btn-sm">Call Now</a>
                    </div>
                </div>
            </div>
        </div>
