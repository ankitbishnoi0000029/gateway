...
$(document).on('click','.changeusrpgmodebtn',function(e) {
	...
	$.ajax({
		...
		success: function(data, status) {
			...
			if (rslt.rescode == 200) {
				window.location.href = "https://pay.a1ejankari.com/imbpro/dashboard";
			}else if (rslt.rescode == 111) {
				window.location.href = "https://pay.a1ejankari.com/imbpg/dashboard";
			} else {
				Swal.fire({
					icon: "error",
					title: "OOPS..!",
					...
					window.location.href = "https://pay.a1ejankari.com/merchant/subscription?stype=prosubs";
				});
			}
