...
$slq_pmode = "SELECT * FROM users where user_token='$user_token'";
    ...
    if($res_pmode[0]["pg_mode"] == 2){
        ...
        $adminarraydata =  getXbyY($slq_admingetdata);
         ...
         $redurl = "https://pay.a1ejankari.com/checkout/pay/$link_token";
    }else{
         $redurl = "https://pay.a1ejankari.com/payment/instant-pay/$link_token";
...
if ($stmt->execute()) {
    ...
    header("Location: https://pay.a1ejankari.com/payment/instant-pay/confirm/$link_token");
