...
<div class="footer">
    ...
    <div class="powered-by">
        <p>Powered by</p>
       <img src="https://pay.a1ejankari.com/newassets/images/Logo.png" style="width: 113px;margin-left: -7px;margin-top: -3px;">
    </div>
</div>
...
function upiCountdown(elm, minute, second, url) {
    ...
    function startTimer() {
        ...
        if(m < 0){
            ...
            window.location.href = "https://pay.a1ejankari.com";
        }
...
$("#paymentForm").submit(function(e){
   ...
   $.ajax({
                type: 'post',
                url: 'https://pay.a1ejankari.com/order4/payment-status',
