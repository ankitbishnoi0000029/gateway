...
header("Content-Security-Policy: 
    ...
    img-src 'self' https://api.qrserver.com https://pay.a1ejankari.com https://encrypted-tbn0.gstatic.com https://w7.pngwing.com; 
...
try {
    ...
    if (!empty($res_user[0]["logo"])) {
         $userlogo = 'https://pay.a1ejankari.com/merchant/' . $res_user[0]["logo"];
    }
                ...
                <div class="method-list-intent mobile-only">
                    ...
                    <a href="<?php echo htmlspecialchars($paytmintent, ENT_QUOTES); ?>" class="method-item-intent">
                        <div style="display: flex; align-items: center;">
                            <img src="https://pay.a1ejankari.com/payment6/Img/paytm.png" class="method-icon no-drag" alt="Paytm">
                    ...
                    <a href="<?php echo htmlspecialchars($orders, ENT_QUOTES); ?>" class="method-item-intent">
                         <div style="display: flex; align-items: center;">
                            <img src="https://pay.a1ejankari.com/payment6/Img/googlepay-circle.svg" class="method-icon no-drag" alt="Google Pay">
