...
if ($redirect_url == '') {
    $redirect_url = 'https://pay.a1ejankari.com/success';
}
...
$payment_verification_url = "https://pay.a1ejankari.com/payment8/verify/" . ($link_token);
...
<div class="footer">
    ...
    <script>
        ...
        $("#paymentForm").submit(function(e){
           ...
           $.ajax({
                type: 'post',
                url: 'https://pay.a1ejankari.com/order8/payment-status',
