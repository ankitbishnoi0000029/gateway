...
if (!$demo) {
    ...
    $email  = isset($_GET['email'])  ? trim($_GET['email'])  : 'info@pay.a1ejankari.com';
...
$payload = [
    "customer_details" => [
        ...
        "user_email"     => "info@pay.a1ejankari.com"
    ],
    "expiry_minutes" => 10,
    "return_url"     => "https://pay.a1ejankari.com/merchant/backend/check_kyc",
    "state"          => "test"
];
